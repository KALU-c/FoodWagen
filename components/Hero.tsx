...
const Hero = () => {
	return (
		<section className="h-[628px] container-desktop bg-primary flex flex-col gap-8 justify-center">
			...
			<Card className="max-w-4xl">
				...
				<CardContent className="flex sm:flex-row flex-col gap-6">
					<div className="relative flex items-center rounded-[8px] focus:border focus-within:ring-1 focus-within:ring-[#F17228] pl-2 bg-[#F5F5F5] flex-1">
