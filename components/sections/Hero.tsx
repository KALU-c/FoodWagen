	...
	return (
		<section className="h-[628px] container-desktop bg-primary flex gap-28 overflow-hidden">
			<div className="flex flex-1 flex-col gap-8 justify-center">
				...
				>
					<h1 className="text-[clamp(2.8125rem,1.7131rem+4.8864vw,5.5rem)] font-bold">Are you starving?</h1>
				...
				>
					<Card className="max-w-6xl gap-5">
						...
						<CardContent className="flex sm:flex-row flex-col gap-6">
							...
							<Button onClick={handleClick} disabled={isFiltering} className="bg-linear-to-r from-[#FF7A7A] to-[#F65900] h-[60px] has-[>svg]:px-12 gap-2 text-lg font-bold">
			...
			<div className="relative self-end h-[500px] aspect-square max-xl:hidden">
				<motion.div
					...
					animate={{ opacity: 1, y: 0 }}
					transition={{ duration: 0.8, delay: 0.2 }}
					className="absolute -bottom-12 w-full h-full drop-shadow-[-20px_40px_50px_rgba(0,0,0,0.6)]"
				>
					<Image
						src={'/hero-image.png'}
						alt="Image"
